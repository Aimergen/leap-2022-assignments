// const arr=[23,7,44,21,10,100,99];
...
//   function gender(medeelel, gender){
//     let urdun=[];
//     for(let i=0; i<medeelel.length; i++){
//         if(medeelel.gender[i]===urdun){
//             urdun.push(gender[i]);
//         }
//     }
//     return urdun;
...
const simplefied=clone(arr, (el)=>{
    return { value: el.id, label: `${el.first_name} ${el.last_name}`};
})

console.log(simplefied);
